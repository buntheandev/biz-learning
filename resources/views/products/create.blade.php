...
@endsection
@section('content')
 <form class="form-validate" action="{{route('product.store')}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if ( Session::has('success') )
                                <div class="alert-list">
                                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                                        <strong>Well Done!</strong> You have added product successful!
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                   <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" name="price" placeholder="$ 0.00" style="text-align: right;">
                                    @error('price')
                                           <span class="text-danger">
                                                {{ $message }}
                                           </span>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                   <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" placeholder="0" style="text-align: right;">
                                    @error('quantity')
                                           <span class="text-danger">
                                                {{ $message }}
                                           </span>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                   <textarea class="form-control  @error('description') is-invalid @enderror" id="description" name="description" rows="5" placeholder="Description"></textarea>
                                     @error('description')
                                           <span class="text-danger">
                                                {{ $message }}
                                           </span>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <img class="card-img-top product-image" id="profile" src="">
