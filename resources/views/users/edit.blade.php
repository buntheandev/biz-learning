...
@endsection
@section('content')
 <form class="form-validate" action="{{route('user.update', $user->id)}}" method="POST" novalidate="novalidate">
    @csrf
    @method('POST')
    <div class="row">
        <!-- End col -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter Your Name" value="{{ $user->name }}">
                                    @error('name')
