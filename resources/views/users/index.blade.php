        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    ...
                    <a href="{{route('user.create')}}" class="btn btn-success pull-right"><i class="feather icon-plus mr-2"></i> Insert</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                               @foreach ($users as $user)
                                    <tr data-expanded="true">
                                        ...
                                        <td>
                                            <a href="{{route('user.edit', $user->id)}}" class="btn btn-success-rgba">
                                                <span class="ti-pencil"></span>
                                            </a>
                                            <a href="{{ route('user.delete', $user->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-danger-rgba" >
